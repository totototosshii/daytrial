				...
				<nav class="footer-sns-buttons">
					<ul>
						<li><a class="m_twitter"
										...
										target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/icon-twitter.png" alt=""></a></li>
						...
						<li><a class="m_hatena"
										...
										rel="nofollow" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/icon-hatena.png" alt=""></a></li>
						<li><a class="m_line" href="https://social-plugins.line.me/lineit/share?url=<?php the_permalink(); ?>"
										rel="nofollow" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/icon-line.png" alt=""></a></li>
